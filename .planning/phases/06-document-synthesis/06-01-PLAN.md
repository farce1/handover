...
must_haves:
  ...
  artifacts:
    ...
    - path: "src/renderers/registry.ts"
      provides: "DOCUMENT_REGISTRY array, GROUP_ALIASES map, ROUND_DEPS map, resolveSelectedDocs, computeRequiredRounds"
      exports: ["DOCUMENT_REGISTRY", "GROUP_ALIASES", "ROUND_DEPS", "resolveSelectedDocs", "computeRequiredRounds"]
...
<task type="auto">
  ...
  <action>
    ...
    **src/renderers/registry.ts** -- Create the document registry:
    ...
    Export DOCUMENT_REGISTRY, GROUP_ALIASES, ROUND_DEPS, resolveSelectedDocs, computeRequiredRounds.
